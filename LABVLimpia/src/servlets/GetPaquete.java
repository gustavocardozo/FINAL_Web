...
public class GetPaquete extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			detallePaquete.append("<br>");
			detallePaquete.append("<p>");
			detallePaquete.append("Desde: " + paquete.getVuelo().getDesde());
			detallePaquete.append("</p>");
			detallePaquete.append("<br>");
			detallePaquete.append("<p>");
			detallePaquete.append("Hacia: " + paquete.getVuelo().getHacia());
			detallePaquete.append("</p>");
			detallePaquete.append("<br>");
			detallePaquete.append("<p>");
			detallePaquete.append("Horario de partida:" + paquete.getVuelo().getPartida());
			detallePaquete.append("</p>");
			detallePaquete.append("<br>");
			detallePaquete.append("<p>");
			detallePaquete.append("Horario de llegada:" + paquete.getVuelo().getLlegada());
			detallePaquete.append("</p>");
			detallePaquete.append("<br>");
			detallePaquete.append("<p>");
